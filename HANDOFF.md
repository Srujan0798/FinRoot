...
- **Latest commit:** `e955fb9` (1087 tests passing / 9 skipped, 3x cold green without deselect, ruff clean, FOUNDATION OK)
...
## FRB Results (measured at `as_of_sha = e955fb9`)
...
Measured FRB lift at HEAD `e955fb9`: FinRoot 0.8741 vs RAG 0.3384 = +158.30% composite lift.
