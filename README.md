...
|---:|---|---|---|
| **35%** | **Reasoning Quality** | 5-axis Self-Critic loop · Rooted Prudence verifier · Digital-Twin-grounded synthesis · FRB harness with RAG baseline delta | `src/finroot/reasoning/critic.py` · `src/finroot/reasoning/prudence.py` · `evals/` · `results/metrics.json` |
