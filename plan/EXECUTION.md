...
| 6 | Evaluation Harness (FRB) | **SHIPPED** | 5/5 | `456e3c0` | 83-task FRB (11 domains), measured: FinRoot 0.8741 vs RAG 0.3384 = +158.30% lift |
...
- 2026-07-25 — Wave-14: env-var hermeticity. Added `digital_twin_db` to `config/settings.py`,
  ...
  `results/metrics.json` regenerated at HEAD `456e3c0`; `finroot-submission.zip` (963,743 bytes,
