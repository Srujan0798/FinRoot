...
| 6 | Evaluation Harness (FRB) | **SHIPPED** | 5/5 | `fe0ffb6` | 83-task FRB (11 domains), measured: FinRoot 0.9007 vs RAG 0.3403 = +164.68% lift |
...
- FRB measured lift: **FinRoot 0.9007 vs RAG 0.3403 = +164.68% composite**, pass@1 0.6265 vs 0.2892 (mean score is the headline metric)
...
- 2026-07-25 — Wave-14: env-var hermeticity. Added `digital_twin_db` to `config/settings.py`,
  ...
  `results/metrics.json` regenerated at HEAD `bc8cc5b`; `finroot-submission.zip` (963,743 bytes,
  339 files, secret-scan clean) rebuilt; docs reconciled.
  Total tests: 1066 passed / 9 skipped. FRB: FinRoot 0.9007 vs RAG 0.3403 = +164.68% lift.
