...
> (as_of_sha `fcfee9e`, n_tasks 83, 11 financial domains). Regenerate anytime with `make evals`.
...
Numbers source: `results/metrics.json` (as_of_sha `fcfee9e`, n_tasks 83, 11 domains).
