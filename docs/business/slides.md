...
> (as_of_sha `80698c2`, n_tasks 83, 11 financial domains). Regenerate anytime with `make evals`.
...
Numbers source: `results/metrics.json` (as_of_sha `80698c2`, n_tasks 83, 11 domains).
