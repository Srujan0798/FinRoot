...
> (as_of_sha `f10e566`, n_tasks 83, 11 financial domains). Regenerate anytime with `make evals`.
...
Numbers source: `results/metrics.json` (as_of_sha `f10e566`, n_tasks 83, 11 domains).
