...
**Headline metric (FRB, 83 tasks, mock k=1, regenerated):** FinRoot mean **0.9117** · pass@1 **1.0000** vs RAG mean **0.3422** = **+166.42%** composite lift at HEAD **f48c226** — `results/metrics.json`.
