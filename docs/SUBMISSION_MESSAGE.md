...
**Headline metric (FRB, 83 tasks, mock k=1, regenerated):** FinRoot mean **0.9114** · pass@1 **1.0000** vs RAG mean **0.3422** = **+166.34%** composite lift at HEAD **fb09935** — `results/metrics.json`.
