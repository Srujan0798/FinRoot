...
**Headline metric (FRB, 83 tasks, mock k=1, regenerated):** FinRoot mean **0.9114** · pass@1 **1.0000** vs RAG mean **0.3390** = **+168.85%** composite lift at HEAD **416b6bc** — `results/metrics.json`.
