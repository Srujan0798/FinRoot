...
**Headline metric (FRB, 83 tasks, mock k=1, regenerated):** FinRoot mean **0.9117** · pass@1 **1.0000** vs RAG mean **0.3390** = **+168.94%** composite lift at HEAD **45b88e6** — `results/metrics.json`.
