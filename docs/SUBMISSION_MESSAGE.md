...
**Headline metric (FRB, 83 tasks, mock k=1, regenerated):** FinRoot mean **0.9092** · pass@1 **1.0000** vs RAG mean **0.3390** = **+168.20%** composite lift at HEAD **90b5e91** — `results/metrics.json`.
