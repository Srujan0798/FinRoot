...
**The one headline metric (FRB, 83 tasks, 11 domains, mock k=1):** **FinRoot mean 0.8677 · pass@1 0.5060 vs RAG mean 0.3403 = +154.98% composite lift at HEAD bc8cc5b** — `results/metrics.json` (regenerated, not hand-typed).
