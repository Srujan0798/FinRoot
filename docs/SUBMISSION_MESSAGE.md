...
**Headline metric (FRB, 83 tasks, mock k=1, regenerated):** FinRoot mean **0.9007** · pass@1 **0.6265** vs RAG mean **0.3403** = **+164.68%** composite lift at HEAD **fe0ffb6** — `results/metrics.json`.
