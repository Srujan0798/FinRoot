...
## Features
- [ ] **Multi-currency / FX-aware reasoning** · NRI & cross-border users · M · earliest wave-9
...
- [ ] **Goal-based planning wizard** · retirement / education corpus · M · earliest wave-9
- [ ] **PDF statement ingestion (CAS/AMC)** · auto-build the Digital Twin · M · earliest wave-9

## Reasoning / quality
- [ ] **Adversarial eval set (red-team prompts)** · catch unsafe advice · M · earliest wave-9
- [ ] **Counterfactual explanations** · "what would change my recommendation" · M · earliest wave-10
...
- [ ] **Distributed tracing (OpenTelemetry → Jaeger)** · deep observability · M · earliest wave-9

## Research
- [ ] **FinBERT vs LLM-judge agreement study** · grader calibration · M · earliest wave-9
